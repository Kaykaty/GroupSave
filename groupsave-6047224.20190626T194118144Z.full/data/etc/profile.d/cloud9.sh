...
export C9_FULLNAME='Katerina I'
export C9_HOSTNAME='groupsave-katerinaivask.c9users.io'
export C9_EMAIL='kaykaty312@gmail.com'
export C9_USER='katerinaivask'
export C9_PROJECT='groupsave'
export C9_PID='6047224'
export C9_UID='1480388'
